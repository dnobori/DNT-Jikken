...
{
    static class OptimizationThresholdTestClass
    {
        public static void Test()
        {
            long a = 123;
            a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32;
            a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32;
            a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32;
            a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32;
            a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32;
            ...
            a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32; if (a == 1) { a = a * 4; } else { a = a * 8; } Limbo.SInt = a * 2; a = Limbo.SInt; a += 32;
            a = Limbo.SInt;
            Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++;
            Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++;
            Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++;
            Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++; Limbo.SInt++;
            Limbo.SInt++;
            //Limbo.SInt++;  // ← コレを増やすと最適化無効になる！！！！
        }
    }
