...
void TestMain(char *cmd)
{
	...
	Print("backup-test1 Test Program\n");
...
int main(int argc, char *argv[])
{
	...
	else
	{
		// Service mode
#ifdef OS_WIN32
		return MsService("BACKUP_TEST1", StartProcess, StopProcess, 0, argv[1]);
#else // OS_WIN32
		return UnixService(argc, argv, "backup-test1", StartProcess, StopProcess);
#endif // OS_WIN32
