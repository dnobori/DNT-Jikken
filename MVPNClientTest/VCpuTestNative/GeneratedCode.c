...
enum CallRetAddress {
    ...
    CallRetAddress__0x80489a1,
    CallRetAddress__0x80489e5,
}
;
...
case CallRetAddress__0x80489a1: goto L_80489a1;
case CallRetAddress__0x80489e5: goto L_80489e5;
default:
...
esp -= 4;
vaddr = esp;
*((uint*)(byte*)(cont_memory_minus_start + vaddr)) = (uint)CallRetAddress__0x80489a1;
...
esp -= 4;
vaddr = esp;
*((uint*)(byte*)(cont_memory_minus_start + vaddr)) = (uint)CallRetAddress__0x80489e5;
...
enum FunctionTable
{
    FunctionTable_test_target1 = 0x80488a0,
    FunctionTable_test_target2 = 0x8048900,
    FunctionTable_test_target4 = 0x8048970,
    FunctionTable_test_target3 = 0x80489d0,
}
;
